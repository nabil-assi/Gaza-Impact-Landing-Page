...
export default function InitiativeDetailPage() {
  // React Router v6+: useParams replaces Route.useParams()
  ...
  // React Router: navigate with search params
  const handleDonate = () => {
    navigate(`/donate?initiativeId=${initiative.id}`);
  };
      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="mt-8 grid gap-12 lg:grid-cols-5">
          ...
          <div className="lg:col-span-3">
            ...
            {/* Description */}
            <div className="prose prose-sm mt-6 max-w-none leading-relaxed text-foreground/80">
                ...
                <div className="mt-5 flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <span>
                    <strong className="text-foreground">
                      {initiative.donorsCount.toLocaleString()}
                    </strong>{" "}
                    donors
                  </span>
                </div>
